...
const TblfichaatencionAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TblfichaatencionAddPage" className="main-page">
    { (props.showHeader) && 
...
TblfichaatencionAddPage.defaultProps = {
	primaryKey: 'fic_id',
	pageName: 'tblfichaatencion',
	apiPath: 'tblfichaatencion/add',
	routeName: 'tblfichaatencionadd',
...
export default TblfichaatencionAddPage;
