...
const TblhistoricoListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblhistorico/view/${data.his_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblhistorico/edit/${data.his_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function HisIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblhistorico/view/${data.his_id}`}> { data.his_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblhistoricoListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Historico"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblhistorico/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="his_id" header="His Id" body={HisIdTemplate}  ></Column>
                                    <Column  field="his_tipo_abm" header="His Tipo Abm"   ></Column>
                                    <Column  field="his_nom_tabla" header="His Nom Tabla"   ></Column>
                                    <Column  field="his_nom_pk" header="His Nom Pk"   ></Column>
                                    <Column  field="his_valor_pk" header="His Valor Pk"   ></Column>
                                    <Column  field="his_campos" header="His Campos"   ></Column>
                                    <Column  field="his_usuario_creacion" header="His Usuario Creacion"   ></Column>
                                    <Column  field="his_fecha_creacion" header="His Fecha Creacion"   ></Column>
...
TblhistoricoListPage.defaultProps = {
	primaryKey: 'his_id',
	pageName: 'tblhistorico',
	apiPath: 'tblhistorico/index',
	routeName: 'tblhistoricolist',
...
export default TblhistoricoListPage;
