...
const TblperiodoListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblperiodo/view/${data.pr_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblperiodo/edit/${data.pr_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function PrIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblperiodo/view/${data.pr_id}`}> { data.pr_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblperiodoListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Periodo"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblperiodo/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="pr_id" header="Pr Id" body={PrIdTemplate}  ></Column>
                                    <Column  field="pr_gestion" header="Pr Gestion"   ></Column>
                                    <Column  field="pr_secuencial" header="Pr Secuencial"   ></Column>
                                    <Column  field="pr_estado" header="Pr Estado"   ></Column>
...
TblperiodoListPage.defaultProps = {
	primaryKey: 'pr_id',
	pageName: 'tblperiodo',
	apiPath: 'tblperiodo/index',
	routeName: 'tblperiodolist',
...
export default TblperiodoListPage;
