...
const TblempleadorAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TblempleadorAddPage" className="main-page">
    { (props.showHeader) && 
...
TblempleadorAddPage.defaultProps = {
	primaryKey: 'em_id',
	pageName: 'tblempleador',
	apiPath: 'tblempleador/add',
	routeName: 'tblempleadoradd',
...
export default TblempleadorAddPage;
