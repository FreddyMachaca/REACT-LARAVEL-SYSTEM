...
const TblpruebainstituciomcarreraListPage = (props) => {
	...
	return (
<main id="TblpruebainstituciomcarreraListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Prueba Instituciom Carrera"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
...
TblpruebainstituciomcarreraListPage.defaultProps = {
	primaryKey: '',
	pageName: 'tblpruebainstituciomcarrera',
	apiPath: 'tblpruebainstituciomcarrera/index',
	routeName: 'tblpruebainstituciomcarreralist',
...
export default TblpruebainstituciomcarreraListPage;
