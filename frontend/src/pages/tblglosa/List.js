...
const TblglosaListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblglosa/view/${data.gl_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblglosa/edit/${data.gl_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function GlIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblglosa/view/${data.gl_id}`}> { data.gl_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblglosaListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Glosa"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblglosa/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="gl_id" header="Gl Id" body={GlIdTemplate}  ></Column>
                                    <Column  field="gl_valor_pk" header="Gl Valor Pk"   ></Column>
                                    <Column  field="gl_nombre_pk" header="Gl Nombre Pk"   ></Column>
                                    <Column  field="gl_tabla" header="Gl Tabla"   ></Column>
                                    <Column  field="gl_tipo_mov" header="Gl Tipo Mov"   ></Column>
                                    <Column  field="gl_tipo_doc" header="Gl Tipo Doc"   ></Column>
                                    <Column  field="gl_glosa" header="Gl Glosa"   ></Column>
                                    <Column  field="gl_numero_doc" header="Gl Numero Doc"   ></Column>
                                    <Column  field="gl_fecha_doc" header="Gl Fecha Doc"   ></Column>
                                    <Column  field="gl_estado" header="Gl Estado"   ></Column>
                                    <Column  field="gl_usuario" header="Gl Usuario"   ></Column>
                                    <Column  field="gl_fecha_registro" header="Gl Fecha Registro"   ></Column>
...
TblglosaListPage.defaultProps = {
	primaryKey: 'gl_id',
	pageName: 'tblglosa',
	apiPath: 'tblglosa/index',
	routeName: 'tblglosalist',
...
export default TblglosaListPage;
