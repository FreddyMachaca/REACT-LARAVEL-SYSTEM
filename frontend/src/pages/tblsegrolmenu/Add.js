...
const TblsegrolmenuAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TblsegrolmenuAddPage" className="main-page">
    { (props.showHeader) && 
...
TblsegrolmenuAddPage.defaultProps = {
	primaryKey: 'rolme_id',
	pageName: 'tblsegrolmenu',
	apiPath: 'tblsegrolmenu/add',
	routeName: 'tblsegrolmenuadd',
...
export default TblsegrolmenuAddPage;
