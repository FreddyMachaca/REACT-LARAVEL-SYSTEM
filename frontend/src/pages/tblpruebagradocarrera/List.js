...
const TblpruebagradocarreraListPage = (props) => {
	...
	return (
<main id="TblpruebagradocarreraListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Prueba Grado Carrera"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
...
TblpruebagradocarreraListPage.defaultProps = {
	primaryKey: '',
	pageName: 'tblpruebagradocarrera',
	apiPath: 'tblpruebagradocarrera/index',
	routeName: 'tblpruebagradocarreralist',
...
export default TblpruebagradocarreraListPage;
