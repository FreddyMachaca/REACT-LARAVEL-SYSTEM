...
const TbltipoeventoacademicoListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tbltipoeventoacademico/view/${data.eac_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tbltipoeventoacademico/edit/${data.eac_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function EacIdTemplate(data){
		if(data){
			return (
				<Link to={`/tbltipoeventoacademico/view/${data.eac_id}`}> { data.eac_id }</Link>
			);
		}
	}
	...
	return (
<main id="TbltipoeventoacademicoListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Tipoevento Academico"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tbltipoeventoacademico/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="eac_id" header="Eac Id" body={EacIdTemplate}  ></Column>
                                    <Column  field="eac_nombre" header="Eac Nombre"   ></Column>
                                    <Column  field="eac_prefijo" header="Eac Prefijo"   ></Column>
                                    <Column  field="eac_estado" header="Eac Estado"   ></Column>
...
TbltipoeventoacademicoListPage.defaultProps = {
	primaryKey: 'eac_id',
	pageName: 'tbltipoeventoacademico',
	apiPath: 'tbltipoeventoacademico/index',
	routeName: 'tbltipoeventoacademicolist',
...
export default TbltipoeventoacademicoListPage;
