...
const TblPersonalList = () => {
        ...
        return (
            <div className="flex gap-2">
                <Button 
                    ...
                    onClick={() => app.navigate(`/gestionPersonal/view/${rowData.per_id}`)}
    ...
    return (
        <div className="card">
            <Title title="Listado de Personal" />
            ...
            >
                ...
                />
                <Column body={actionTemplate} header="Acciones" style={{width: '150px'}} />
            </DataTable>
        </div>
    );
};

export default TblPersonalList;
