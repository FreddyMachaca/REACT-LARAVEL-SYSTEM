...
const TblpruebagradoinstitucionListPage = (props) => {
	...
	return (
<main id="TblpruebagradoinstitucionListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Prueba Grado Institucion"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                    ...
                    <div >
                        ...
                        <div className="page-records">
                            <DataTable 
                                ...
                                >
                                {/*PageComponentStart*/}
                                <Column  field="id_grado" header="Id Grado"   ></Column>
                                <Column  field="id_depto" header="Id Depto"   ></Column>
                                <Column  field="depto" header="Depto"   ></Column>
                                <Column  field="universidad" header="Universidad"   ></Column>
                                <Column  field="id_intitucion" header="Id Intitucion"   ></Column>
                                {/*PageComponentEnd*/}
                            </DataTable>
                        </div>
                        <PageFooter />
...
TblpruebagradoinstitucionListPage.defaultProps = {
	primaryKey: '',
	pageName: 'tblpruebagradoinstitucion',
	apiPath: 'tblpruebagradoinstitucion/index',
	routeName: 'tblpruebagradoinstitucionlist',
...
export default TblpruebagradoinstitucionListPage;
