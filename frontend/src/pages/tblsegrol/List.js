...
const TblsegrolListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblsegrol/view/${data.rol_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblsegrol/edit/${data.rol_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function RolIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblsegrol/view/${data.rol_id}`}> { data.rol_id }</Link>
			);
		}
	}
    ...
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Seg Rol"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="rol_id" header="Rol Id" body={RolIdTemplate}  ></Column>
                                    <Column  field="rol_descripcion" header="Rol Descripcion"   ></Column>
                                    <Column  field="rol_estado" header="Rol Estado"   ></Column>
                                    <Column  field="rol_fecha_creacion" header="Rol Fecha Creacion"   ></Column>
                                    <Column  field="rol_usuario_creacion" header="Rol Usuario Creacion"   ></Column>
