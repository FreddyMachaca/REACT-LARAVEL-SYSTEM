...
const TblsegusuarioEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TblsegusuarioEditPage" className="main-page">
    { (props.showHeader) && 
...
TblsegusuarioEditPage.defaultProps = {
	primaryKey: 'us_id',
	pageName: 'tblsegusuario',
	apiPath: 'tblsegusuario/edit',
	routeName: 'tblsegusuarioedit',
...
export default TblsegusuarioEditPage;
