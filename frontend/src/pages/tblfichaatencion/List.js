...
const TblfichaatencionListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblfichaatencion/view/${data.fic_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblfichaatencion/edit/${data.fic_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function FicIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblfichaatencion/view/${data.fic_id}`}> { data.fic_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblfichaatencionListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Fichaatencion"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblfichaatencion/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="fic_id" header="Fic Id" body={FicIdTemplate}  ></Column>
                                    <Column  field="fic_correlativo" header="Fic Correlativo"   ></Column>
                                    <Column  field="fic_atencionsolicitud" header="Fic Atencionsolicitud"   ></Column>
                                    <Column  field="fic_atencioninicio" header="Fic Atencioninicio"   ></Column>
                                    <Column  field="fic_atencionfinal" header="Fic Atencionfinal"   ></Column>
                                    <Column  field="fic_usr_id" header="Fic Usr Id"   ></Column>
                                    <Column  field="fic_usrname" header="Fic Usrname"   ></Column>
                                    <Column  field="fic_estado" header="Fic Estado"   ></Column>
...
TblfichaatencionListPage.defaultProps = {
	primaryKey: 'fic_id',
	pageName: 'tblfichaatencion',
	apiPath: 'tblfichaatencion/index',
	routeName: 'tblfichaatencionlist',
...
export default TblfichaatencionListPage;
