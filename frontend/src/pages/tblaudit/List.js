...
const TblauditListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblaudit/view/${data.audi_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblaudit/edit/${data.audi_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
			command: (event) => { deleteItem(data.audi_id) },
			icon: "pi pi-trash"
		}
	]
		return (<SplitButton dropdownIcon="pi pi-bars" className="dropdown-only p-button-text p-button-plain" model={items} />);
	}
	function AudiIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblaudit/view/${data.audi_id}`}> { data.audi_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblauditListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Audit"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblaudit/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="audi_id" header="Audi Id" body={AudiIdTemplate}  ></Column>
                                    <Column  field="audi_tipo_abm" header="Audi Tipo Abm"   ></Column>
                                    <Column  field="audi_nom_tabla" header="Audi Nom Tabla"   ></Column>
                                    <Column  field="audi_nom_pk" header="Audi Nom Pk"   ></Column>
                                    <Column  field="audi_valor_pk" header="Audi Valor Pk"   ></Column>
                                    <Column  field="audi_campos" header="Audi Campos"   ></Column>
                                    <Column  field="audi_fecha_creacion" header="Audi Fecha Creacion"   ></Column>
                                    <Column  field="audi_usuario_creacion" header="Audi Usuario Creacion"   ></Column>
...
TblauditListPage.defaultProps = {
	primaryKey: 'audi_id',
	pageName: 'tblaudit',
	apiPath: 'tblaudit/index',
	routeName: 'tblauditlist',
...
export default TblauditListPage;
