...
const TblbsegsListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblbsegs/view/${data.egs_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblbsegs/edit/${data.egs_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function EgsIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblbsegs/view/${data.egs_id}`}> { data.egs_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblbsegsListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Bs Egs"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblbsegs/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="egs_id" header="Egs Id" body={EgsIdTemplate}  ></Column>
                                    <Column  field="egs_abr" header="Egs Abr"   ></Column>
                                    <Column  field="egs_descripcion" header="Egs Descripcion"   ></Column>
                                    <Column  field="egs_fa_id" header="Egs Fa Id"   ></Column>
                                    <Column  field="egs_ca_entidad" header="Egs Ca Entidad"   ></Column>
...
TblbsegsListPage.defaultProps = {
	primaryKey: 'egs_id',
	pageName: 'tblbsegs',
	apiPath: 'tblbsegs/index',
	routeName: 'tblbsegslist',
...
export default TblbsegsListPage;
