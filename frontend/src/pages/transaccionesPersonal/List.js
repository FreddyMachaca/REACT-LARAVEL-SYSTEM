...
const TblTransaccionesList = () => {
        ...
        return (
            <div className="flex gap-2">
                <Button 
                    ...
                    onClick={() => app.navigate(`/tblTransacciones/add/${rowData.per_id}`)}
    ...
    return (
        <div className="card">
            <Title title="Transacciones de Personal" />
...
export default TblTransaccionesList;
