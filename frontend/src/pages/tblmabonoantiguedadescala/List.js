...
const TblmabonoantiguedadescalaListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblmabonoantiguedadescala/view/${data.ba_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblmabonoantiguedadescala/edit/${data.ba_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function BaIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblmabonoantiguedadescala/view/${data.ba_id}`}> { data.ba_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblmabonoantiguedadescalaListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Ma Bono Antiguedad Escala"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblmabonoantiguedadescala/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="ba_id" header="Ba Id" body={BaIdTemplate}  ></Column>
                                    <Column  field="ba_tiempo_minimo" header="Ba Tiempo Minimo"   ></Column>
                                    <Column  field="ba_tiempo_maximo" header="Ba Tiempo Maximo"   ></Column>
                                    <Column  field="ba_porcentaje" header="Ba Porcentaje"   ></Column>
                                    <Column  field="ba_estado" header="Ba Estado"   ></Column>
...
TblmabonoantiguedadescalaListPage.defaultProps = {
	primaryKey: 'ba_id',
	pageName: 'tblmabonoantiguedadescala',
	apiPath: 'tblmabonoantiguedadescala/index',
	routeName: 'tblmabonoantiguedadescalalist',
...
export default TblmabonoantiguedadescalaListPage;
