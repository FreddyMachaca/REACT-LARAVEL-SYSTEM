...
const ContractItemEditForm = ({ contrato, onSave, isSubPage }) => {
    const app = useApp();
    ...
    const handleSubmit = (values, { setSubmitting }) => {
        ...
        try {
            ...
            app.flashMsg("Error", "Ocurrió un error al actualizar el contrato", "error");
        } finally {
            setSubmitting(false);
        }
    };
        ...
        <div className={isSubPage ? '' : 'card shadow-2'}>
            {!isSubPage && (
                <div className="card-header bg-primary text-white p-3">
                    <h5 className="m-0">Editar Contrato</h5>
                </div>
            )}
            <div className="p-3">
                <Formik
...
ContractItemEditForm.defaultProps = {
    isSubPage: false
};

export default ContractItemEditForm;
