...
const TblrequisitoformacionListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblrequisitoformacion/view/${data.rf_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblrequisitoformacion/edit/${data.rf_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function RfIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblrequisitoformacion/view/${data.rf_id}`}> { data.rf_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblrequisitoformacionListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Requisito Formacion"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblrequisitoformacion/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="rf_id" header="Rf Id" body={RfIdTemplate}  ></Column>
                                    <Column  field="rf_formacion" header="Rf Formacion"   ></Column>
                                    <Column  field="rf_exp_gral" header="Rf Exp Gral"   ></Column>
                                    <Column  field="rf_exp_esp" header="Rf Exp Esp"   ></Column>
                                    <Column  field="rf_exp_mun" header="Rf Exp Mun"   ></Column>
                                    <Column  field="rf_exp_mun_esp" header="Rf Exp Mun Esp"   ></Column>
                                    <Column  field="rf_estado" header="Rf Estado"   ></Column>
...
TblrequisitoformacionListPage.defaultProps = {
	primaryKey: 'rf_id',
	pageName: 'tblrequisitoformacion',
	apiPath: 'tblrequisitoformacion/index',
	routeName: 'tblrequisitoformacionlist',
...
export default TblrequisitoformacionListPage;
