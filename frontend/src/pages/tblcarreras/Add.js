...
const TblcarrerasAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TblcarrerasAddPage" className="main-page">
    { (props.showHeader) && 
...
TblcarrerasAddPage.defaultProps = {
	primaryKey: 'carr_id',
	pageName: 'tblcarreras',
	apiPath: 'tblcarreras/add',
	routeName: 'tblcarrerasadd',
...
export default TblcarrerasAddPage;
