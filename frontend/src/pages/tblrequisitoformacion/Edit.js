...
const TblrequisitoformacionEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TblrequisitoformacionEditPage" className="main-page">
    { (props.showHeader) && 
...
TblrequisitoformacionEditPage.defaultProps = {
	primaryKey: 'rf_id',
	pageName: 'tblrequisitoformacion',
	apiPath: 'tblrequisitoformacion/edit',
	routeName: 'tblrequisitoformacionedit',
...
export default TblrequisitoformacionEditPage;
