...
const TblsegmenuusuarioListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblsegmenuusuario/view/${data.meus_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblsegmenuusuario/edit/${data.meus_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function MeusIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblsegmenuusuario/view/${data.meus_id}`}> { data.meus_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblsegmenuusuarioListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Seg Menu Usuario"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblsegmenuusuario/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="meus_id" header="Meus Id" body={MeusIdTemplate}  ></Column>
                                    <Column  field="meus_me_id" header="Meus Me Id"   ></Column>
                                    <Column  field="meus_us_id" header="Meus Us Id"   ></Column>
                                    <Column  field="meus_estado" header="Meus Estado"   ></Column>
                                    <Column  field="meus_fecha_creacion" header="Meus Fecha Creacion"   ></Column>
                                    <Column  field="meus_usuario_creacion" header="Meus Usuario Creacion"   ></Column>
...
TblsegmenuusuarioListPage.defaultProps = {
	primaryKey: 'meus_id',
	pageName: 'tblsegmenuusuario',
	apiPath: 'tblsegmenuusuario/index',
	routeName: 'tblsegmenuusuariolist',
...
export default TblsegmenuusuarioListPage;
