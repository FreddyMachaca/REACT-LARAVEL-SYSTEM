...
const TblareaformacionListPage = (props) => {
	...
	return (
<main id="TblareaformacionListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Area Formacion"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                    ...
                    <div >
                        ...
                        <div className="page-records">
                            <DataTable 
                                ...
                                >
                                {/*PageComponentStart*/}
                                <Column  field="af_id" header="Af Id"   ></Column>
                                <Column  field="af_nombre" header="Af Nombre"   ></Column>
                                <Column  field="af_estado" header="Af Estado"   ></Column>
                                {/*PageComponentEnd*/}
                            </DataTable>
                        </div>
                        <PageFooter />
...
TblareaformacionListPage.defaultProps = {
	primaryKey: '',
	pageName: 'tblareaformacion',
	apiPath: 'tblareaformacion/index',
	routeName: 'tblareaformacionlist',
...
export default TblareaformacionListPage;
