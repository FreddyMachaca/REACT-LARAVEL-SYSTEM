...
/* routes for TblSegMenu Controller  */
    ...
    Route::get('tblsegmenu/rol/{rec_id}', 'TblSegMenuController@getMenuByRol');
   // Route::get('tblsegmenu/menu-tree', 'TblSegMenuController@getMenuTree');
...
/* routes for TblSegRol Controller  */
    ...
    Route::post('tblsegrol/add', [TblSegRolController::class, 'add']);
    Route::put('tblsegrol/edit/{rec_id}', [TblSegRolController::class, 'edit']);
