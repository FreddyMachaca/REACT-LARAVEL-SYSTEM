        ...
        return (
            <div className="flex gap-2">
                <Button 
                    ...
                    onClick={() => app.navigate(`/tbltipoaportante/asignar/${rowData.per_id}`)}
                    tooltip="Asignar Tipo Aportante"
                />
            </div>
        );
    };
...
export default TblTipoAportanteList;
