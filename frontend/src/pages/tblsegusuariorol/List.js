...
const TblsegusuariorolListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblsegusuariorol/view/${data.usrol_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblsegusuariorol/edit/${data.usrol_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function UsrolIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblsegusuariorol/view/${data.usrol_id}`}> { data.usrol_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblsegusuariorolListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Seg Usuario Rol"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblsegusuariorol/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="usrol_id" header="Usrol Id" body={UsrolIdTemplate}  ></Column>
                                    <Column  field="usrol_us_id" header="Usrol Us Id"   ></Column>
                                    <Column  field="usrol_rol_id" header="Usrol Rol Id"   ></Column>
                                    <Column  field="usrol_estado" header="Usrol Estado"   ></Column>
                                    <Column  field="usrol_fecha_creacion" header="Usrol Fecha Creacion"   ></Column>
                                    <Column  field="usrol_usuario_creacion" header="Usrol Usuario Creacion"   ></Column>
...
TblsegusuariorolListPage.defaultProps = {
	primaryKey: 'usrol_id',
	pageName: 'tblsegusuariorol',
	apiPath: 'tblsegusuariorol/index',
	routeName: 'tblsegusuariorollist',
...
export default TblsegusuariorolListPage;
