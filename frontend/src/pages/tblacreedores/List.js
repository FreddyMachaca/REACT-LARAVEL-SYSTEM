...
const TblacreedoresListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblacreedores/view/${data.ac_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblacreedores/edit/${data.ac_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function AcIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblacreedores/view/${data.ac_id}`}> { data.ac_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblacreedoresListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Acreedores"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblacreedores/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="ac_id" header="Ac Id" body={AcIdTemplate}  ></Column>
                                    <Column  field="ac_descripcion" header="Ac Descripcion"   ></Column>
                                    <Column  field="ac_tipo" header="Ac Tipo"   ></Column>
                                    <Column  field="ac_documento" header="Ac Documento"   ></Column>
                                    <Column  field="ac_estado" header="Ac Estado"   ></Column>
...
TblacreedoresListPage.defaultProps = {
	primaryKey: 'ac_id',
	pageName: 'tblacreedores',
	apiPath: 'tblacreedores/index',
	routeName: 'tblacreedoreslist',
...
export default TblacreedoresListPage;
