...
use App\Http\Controllers\TblLicenciaJustificadaController;
...
/* routes for TblPersona Controller */
    ...
    Route::get('/opciones/{personaId}', [TblPersonaController::class, 'obtenerOpciones']);
/* New Routes for Licencias */
    ...
    /***se agrega para las alertas** */
    Route::get('/pending-authorizations/{autorizaId}', 'TblLicenciaJustificadaController@getPendingAuthorizations');
    Route::post('/authorizations/{id}/approve', 'TblLicenciaJustificadaController@approveAuthorization');
    Route::get('/pendientes', 'TblLicenciaJustificadaController@pendientes');
});
...
/* routes for FileUpload Controller  */
    ...
    Route::get('/tbllicenciajustificada/persona/{personaId}', [TblLicenciaJustificadaController::class,'obtenerPersona']);
    //mostrar licencias por autorizador
    Route::get('/licencias/autorizador/{autorizaId}', [TblLicenciaJustificadaController::class, 'obtenerLicenciasPorAutorizador']);
    ...
    /****rutas de alerta de licencias justificadas* */
