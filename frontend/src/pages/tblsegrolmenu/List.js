...
const TblsegrolmenuListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblsegrolmenu/view/${data.rolme_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblsegrolmenu/edit/${data.rolme_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function RolmeIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblsegrolmenu/view/${data.rolme_id}`}> { data.rolme_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblsegrolmenuListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Seg Rol Menu"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblsegrolmenu/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="rolme_id" header="Rolme Id" body={RolmeIdTemplate}  ></Column>
                                    <Column  field="rolme_rol_id" header="Rolme Rol Id"   ></Column>
                                    <Column  field="rolme_me_id" header="Rolme Me Id"   ></Column>
                                    <Column  field="rolme_estado" header="Rolme Estado"   ></Column>
                                    <Column  field="rolme_usuario_creacion" header="Rolme Usuario Creacion"   ></Column>
                                    <Column  field="rolme_fecha_creacion" header="Rolme Fecha Creacion"   ></Column>
...
TblsegrolmenuListPage.defaultProps = {
	primaryKey: 'rolme_id',
	pageName: 'tblsegrolmenu',
	apiPath: 'tblsegrolmenu/index',
	routeName: 'tblsegrolmenulist',
...
export default TblsegrolmenuListPage;
